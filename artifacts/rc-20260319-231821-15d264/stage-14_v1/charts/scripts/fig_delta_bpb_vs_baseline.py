...
ax.set_ylabel("Δ val_bpb (candidate − baseline)")
ax.set_title("Change in Validation bpb Relative to Baseline")
ax.set_xticks(x)
ax.set_xticklabels([c.replace("_", " ") for c in conditions], rotation=25, ha="right", fontsize=9)
ax.grid(True, axis="y", alpha=0.3)
ax.set_axisbelow(True)
fig.tight_layout()
fig.savefig("/home/alex/Projects/AutoResearchClaw/artifacts/rc-20260319-231821-15d264/stage-14/charts/fig_delta_bpb_vs_baseline.png")
plt.close(fig)
print(f"Saved: /home/alex/Projects/AutoResearchClaw/artifacts/rc-20260319-231821-15d264/stage-14/charts/fig_delta_bpb_vs_baseline.png")
